...
//	demostrating multiple constructor for different use cases
	...
	Bankaccount(String account_name, double initial_deposit){
		this.account_name=account_name;
		this.initial_deposit=initial_deposit;
		total_no_of_account++;
	}
	Bankaccount(String account_name, double initial_deposit, String account_type){
		this.account_name=account_name;
		this.initial_deposit=initial_deposit;
...
//			deposit(initial_deposit,transaction_type);
		...
		Bankaccount bnk_acc=new Bankaccount(account_name);
		Bankaccount bnk_acc_TwoPara=new Bankaccount(account_name, initial_deposit);
		Bankaccount bnk_acc_ThreePara=new Bankaccount(account_name, initial_deposit, account_type);
